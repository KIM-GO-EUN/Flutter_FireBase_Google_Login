...
import 'package:flutter_test4/screens/user_info_correction.dart';
import 'package:flutter_test4/screens/user_info_withdrawal.dart';
import 'package:flutter_test4/utils/authentication.dart';
import 'package:flutter_test4/widgets/app_bar_title.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: () async{
                ...
                setState((){
                  nickname = memberData['닉네임'];
                  gender = memberData['성별'];
                  area = memberData['지역'];
                  aboutMe = memberData['자기소개'];
                });
              },

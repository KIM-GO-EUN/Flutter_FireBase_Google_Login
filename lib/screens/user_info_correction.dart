...
import 'package:flutter_test4/screens/sign_up_screen.dart';
...
class UserInfoCorrection extends StatefulWidget {
  const UserInfoCorrection({Key? key}) : super(key: key);

  @override
  State createState() => UserInfoCorrectionState();
}

class UserInfoCorrectionState extends State<UserInfoCorrection> {
            ...
            children: <Widget>[
              Container(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(hintText: ' 수정할 닉네임을 입력해 주세요.'),
                  onChanged: (value1) {
                    setState((){
                      nickname = value1;
                    });
              ...
              Container(
                child: TextFormField(
                  ...
                  style: TextStyle(fontSize: 16, color: CustomColors.firebaseGrey),
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(hintText: '수정할 살고 있는 지역을 입력해 주세요.'),
                  onChanged: (value2) {
                    setState((){
                      area = value2;
                    });
              ...
              Container(
                child: TextFormField(
                  ...
                  style: TextStyle(fontSize: 16, color: CustomColors.firebaseGrey),
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(hintText: '수정할 자기소개를 입력해 주세요.'),
                  onChanged: (value3) {
                    setState((){
                      aboutMe = value3;
                    });
